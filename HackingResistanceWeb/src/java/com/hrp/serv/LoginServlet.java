...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (loginBeanManager.checkLogin(loginBean)) {
                request.getSession().setAttribute(AppConstants.LOGIN_SESSION, loginBean);
                response.sendRedirect("usr_hme.jsp");
            } else {
                response.sendRedirect("index.jsp?user_type=invalid");
            }
