 ...
 */
public class UpdateIMEIServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (loginBean != null) {
                ...
                userBean.setOneTimekey(request.getParameter("otp"));
                userBean.setImei(request.getParameter("imei"));
                String blacklist = request.getParameter("bl");
                LoginBeanManager loginBeanManager = new LoginBeanManager();
                if (loginBeanManager.updateImei(userBean, blacklist)) {
                    response.sendRedirect("usr_account_imei.jsp?update=yes");
                } else {
                    response.sendRedirect("usr_account_imei.jsp?update=fail");
                }
            } else {
            ...
            Logger.getLogger(UpdateIMEIServlet.class.getName()).log(Level.SEVERE, null, ex);
