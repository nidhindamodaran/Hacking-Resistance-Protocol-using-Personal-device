                    ...
                    <div>
                        <nav>
                            <ul class="menu">
                                ...
                                <li class="current"><a href="#">ChangeImei</a></li>
            ...
            <div>
                <div class="wrap">
                    <div class="col-1 border-2">
                        <h3>Update IMEI Details</h3>
                        <p>*Please check your mail for new OTP</p>


                        <form id="form" method="post" action="UpdateIMEIServlet">
                            <fieldset>

                                <label><strong>Password:</strong>
                                    <input type="password" name="password" id="password" required="required"    />
                                </label>
                                <label><strong>OTP:</strong>
                                ...
                                <label><strong>Black list :</strong>
                                    <select name="bl" id="bl" >
                                        <option value="no"> Do not Blacklist </option>
                                        <option value="yes"> Blacklist </option>
                            ...
                            %>
                            <b style="color: #FF9900;">Successfully Updated IMEI</b>
                            <%} else if (userType != null && userType.equals("fail")) {%>
                            <b style="color: #FF9900;">Fails to update IMEI</b>
                            <% }%>
                        </form>
