...
<html lang="en">
    <head>
        <title>Hacking Resistance  | Register</title>
        <meta charset="utf-8">
            ...
            <div>
                <div class="wrap">
                    <div class="col-1 border-2">
                        <h2>User Register</h2>
                        <form id="form" method="post" action="UserRegServlet">
                            <fieldset>
                                ...
                                <label><strong>IMEI :</strong>
                                    <input type="tel" name="imei"  required="required" pattern="[0-9]{15,15}"  value=""/>
                                </label>
